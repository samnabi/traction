...
<?php if (!isset($success) and !get('success')) { ?>
  ...
  <?php if (isset($error)) { ?>
    <p class="success">Sorry, something went wrong.</p>
  <?php } ?>
...
<?php if (isset($campaign['social_text'])) { ?>
  <div class="social">
    ...
    <div class="flex">
      <a target="_blank" href="https://twitter.com/intent/tweet?text=<?= urlencode($campaign['social_text']) ?>&amp;url=<?= urlencode($campaign['social_url']) ?>&amp;via=<?= $campaign['twitter'] ?>">
      ...
      <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($campaign['social_url']) ?>&amp;quote=<?= urlencode($campaign['social_text']) ?>">
